      ...
      <div className="w-full max-w-7xl bg-white rounded-3xl shadow-2xl overflow-hidden flex flex-col lg:flex-row">
        ...
        <div className="lg:w-2/5 bg-gradient-to-br from-green-50 to-white p-10 flex flex-col">
          ...
          <img
            src={smoothie}
            alt="Smoothie"
            className="w-80 md:w-96 mt-16 mx-auto rounded-3xl rotate-6 transition-all duration-500 hover:rotate-0 hover:-translate-y-3 hover:scale-105 hover:shadow-[0_40px_80px_rgba(0,0,0,0.35)]"
          />
